...
mat = scipy.io.loadmat(r'F:\Juhon\python\EdX Azure\Python for DS\Module4\Datasets\face_data.mat')
...
# loaded it correctly.
label = pd.read_csv(r'F:\Juhon\python\EdX Azure\Python for DS\Module5\Datasets\face_labels.csv', header=None)
label = label[0]
...
# than as points:
data_train, data_test, label_train, label_test = train_test_split(df, label, random_state=7, test_size=0.15)

...
path = r'F:\Juhon\python\EdX Azure\Python for DS\Module5\Datasets\life_expectancy.csv'
...
# loaded dataset
print(df.loc[df.Year==2014, 'WhiteMale'])
...
print(df.loc[df.Year==2014, 'BlackFemale'])

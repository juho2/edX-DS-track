...
path = r'F:\Juhon\python\EdX Azure\Python for DS\Module6\Datasets\wheat.data'
X = pd.read_csv(path, index_col='id')
...
dectree = DTree(max_depth=1, random_state=2)
...
benchmark(dectree, X_train, X_test, y_train, y_test, 'DecTree')
drawPlots(dectree, X_train, X_test, y_train, y_test, 'DecTree')

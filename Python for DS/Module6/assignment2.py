...
X_train, X_test, y_train, y_test = load(r'F:\Juhon\python\EdX Azure\Python for DS\Module6\Datasets\optdigits.tes',
                                        r'F:\Juhon\python\EdX Azure\Python for DS\Module6\Datasets\optdigits.tra')
...
guess_1000th_test_value = svc.predict(X_test.loc[999].reshape(1,-1))

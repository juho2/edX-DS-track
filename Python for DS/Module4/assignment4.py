...
#Plot2D(T, 'PCA 1-1', 1, 1, num_to_plot=40)
#Plot2D(T, 'PCA 1-2', 1, 2, num_to_plot=40)
Plot3D(T, 'PCA 3d', 0,1,2)

# TODO: Implement Isomap here. Reduce the dataframe df down
# to THREE components. Once you've done that, call Plot2D using
# the first two components.
iso = Isomap(n_neighbors=3, n_components=3, n_jobs=-1)
T = iso.fit_transform(df)

#Plot2D(T, 'Isomap 0-1', 0, 1, num_to_plot=40)
#Plot2D(T, 'Isomap 1-1', 1, 1, num_to_plot=40)
#Plot2D(T, 'Isomap 1-2', 1, 2, num_to_plot=40)
